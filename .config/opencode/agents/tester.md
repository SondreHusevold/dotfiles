...
Use `dotnet test` for dotnet test projects.

Check `package.json` for the frontend test command and framework. Use project-specific commands, not generic ones.
...
- Be careful of adding third-party testing frameworks to projects. Ask the user for permission if you recommend using a non-approved nuget.
