 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+-------|
 * | Shift|   <  |   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |  -   |    R_SHIFT   |  
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+-------|
 * | Ctrl | META | Alt  |                 Space                          | ALTGR| META |TGL FN| CTRL  |
 * `--------------------------------------------------------------------------------------------------'
 */
...
const uint16_t keymaps_default[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_iso(
        ...
        KC_LSFT, NO_LESS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  NO_ALGR, KC_LGUI, TT(1), KC_RCTL
    ),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+-------|
 * |      | VOL- | VOL+ | MUTE |      |      |      |      |      |      |      |  UP  |    DOWN      |  
 * |------+------+------+------+------+------+------+------+------+------+------+------+------+-------|
 * |      |      |      |                                                |TGL FN| LEFT |TGL FN| RIGHT |
 * `--------------------------------------------------------------------------------------------------'
 */
    [1] = LAYOUT_60_iso(
        ...
        _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_INS, KC_LOCK ,  M(0), _______, 
        _______, _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, _______,  BL_DEC, BL_TOGG,  BL_INC, KC_UP,  KC_DOWN,
        _______, _______, _______, _______, _______, KC_LEFT, KC_TRNS, KC_RIGHT
    ),
#else
    #error "No Keymap!"
#endif
